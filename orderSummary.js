...
{
  console.log(tellimus.rows[i].name + "; " + tellimus.rows[i].amount + "; " + (tellimus.rows[i].price + (tellimus.rows[i].price * tellimus.rows[i].vat)).toFixed(2))       
  allPrice = allPrice + (tellimus.rows[i].price + tellimus.rows[i].price * tellimus.rows[i].vat) * tellimus.rows[i].amount
}
